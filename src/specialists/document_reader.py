...
FORMATO:
{"claim_id":"...","summary_text":"...","amount_eur":0.0,"claim_type":"...",\
"claimant_id":"...","numero_sinistro":"...","incident_date":"YYYY-MM-DD",\
"policy_id":"...","frozen":false,"in_contenzioso":false}"""
...
def run_document_reader(claim_id: str) -> dict:
    ...
    messages = [{"role": "user", "content": (
        ...
        "Usa fetch_claim poi restituisci il JSON ClaimSummary."
    )}]
